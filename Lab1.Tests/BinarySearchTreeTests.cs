using System;
using System.Linq;
using Lab1Tree.Tests.Core;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace Lab1Tree.Tests
{
    [TestClass]
    public class BinarySearchTreeTests
    {
        private static readonly Student[] Students = {
            new Student("Alexander", "Barykin", "Music", DateTime.Parse("02/08/1822"), 10),
            new Student("Gleb", "Samojlow", "Philosophy", DateTime.Parse("03/06/1995"), 3),
            new Student("Alfred", "Nobel", "Boom", DateTime.Parse("04/02/1899"), 6)
        };
